                                                                        ...
                                                                        child: Padding(
                                                                          ...
                                                                          child: Column(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              ...List.generate(atTableOrders[index]['items'].length, (itemIndex){
                                                                                return Text("${atTableOrders[index]['items'][itemIndex]['category']} ${atTableOrders[index]['items'][itemIndex]['name']} ${atTableOrders[index]['items'][itemIndex]['size'] ?? ""} x ${atTableOrders[index]['items'][itemIndex]['quantity']}");
                                                                              }),
                                                                              Row(
                                                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                                children: [
                                                                                                    ...
                                                                                                    children: [
                                                                                                      ...
                                                                                                      Row(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          ...
                                                                                                          TextButton(
                                                                                                            style: Theme.of(context).textButtonTheme.style?.copyWith(
                                                                                                              foregroundColor: WidgetStateProperty.all<Color>(Colors.white.withOpacity(0.7)),
                                                                                                            ),
