...
class SignUpView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(S.of(context).sing_up)),
                    ...
                    children: [
                      ...
                      StatefulBuilder(
                        builder: (context, setState) {
                          void handleAgreement(bool? value) {
                            if (value == true) {
                          ...
                          return GestureDetector(
                            onTap: () => handleAgreement(!agreeToTerms),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(S.of(context).agree_to_terms),
                                ),
                              ],
                            ),
                          );
                              ...
                              onPressed: () async {
                                ...
                                if (nameController.text.isEmpty ||
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    ErrorMessage(S.of(context).fields_empty),
                                  );
                                } else if (!agreeToTerms) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    ErrorMessage(
                                      S.of(context).you_must_agree_to_terms,
                                    ),
                                  );
                                }
                                  ...
                                  try {
                                    ...
                                    if (res.isEmpty && client.isEmpty) {
                                      ...
                                      ScaffoldMessenger.of(
                                        ...
                                        ErrorMessage(
                                          S.of(context).account_already_exists,
                                        ),
                                      );
                                      ref
                                              .read(
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      ErrorMessage(
                                        S.of(context).invalid_credentials,
                                      ),
                                    );
                                    ref
                                            .read(savingLoadingButton.notifier)
                                            .state =
                                        false;
                                  } catch (error) {
                                    ScaffoldMessenger.of(context).showSnackBar(
